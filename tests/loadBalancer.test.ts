  ...
  describe("load balancing algorithms", function() {
    ...
    context("weighted-largest", function() {
      ...
      it("can differentiate specs between e2e and component", function() {
        ...
        expect(componentRunners).to.deep.eq([["50.1.test.ct.ts", "10.1.test.ct.ts", "10.2.test.ct.ts", "5.1.test.ct.ts"]]);
      });
      ...
      context("specific cases based on time distribution", function() {
        ...
        it("every test file has equal (median) time", function() {
        ...
        it("bell-curve distribution", function() {
          ...
          assertTotalRunnerTime(this.loadBalancingMap, "e2e", runners[0], 600);
          assertTotalRunnerTime(this.loadBalancingMap, "e2e", runners[1], 600);
          assertTotalRunnerTime(this.loadBalancingMap, "e2e", runners[2], 601);
        });

        it("extreme high values", function() {
        ...
        it("extreme low values, example 1: sum of total low values equals highest value", function() {
          const fixture = getFixture<LoadBalancingMap>("spec-map/extreme-lows-equal-to-highest-value.json", { parseJSON: true });
          stubReadLoadBalancerFile(sandbox, fixture);
          this.loadBalancingMap = fixture;
          this.filePaths = Object.keys(this.loadBalancingMap.e2e);
        ...
        it("extreme low values, example 2: sum of total low values is greater than highest value", function() {
          const fixture = getFixture<LoadBalancingMap>("spec-map/extreme-lows-greater-than-highest-value.json", { parseJSON: true });
          stubReadLoadBalancerFile(sandbox, fixture);
          this.loadBalancingMap = fixture;
          this.filePaths = Object.keys(this.loadBalancingMap.e2e);
          ...
          assertTotalRunnerTime(this.loadBalancingMap, "e2e", runners[0], 1000);
          assertTotalRunnerTime(this.loadBalancingMap, "e2e", runners[1], 1100);

        });

        it("extreme center distribution", function() {
          const fixture = getFixture<LoadBalancingMap>("spec-map/extreme-center-distribution.json", { parseJSON: true });
          stubReadLoadBalancerFile(sandbox, fixture);
          this.loadBalancingMap = fixture;
          this.filePaths = Object.keys(this.loadBalancingMap.e2e);
